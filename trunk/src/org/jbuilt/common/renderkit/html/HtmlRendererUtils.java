 ...
 * under the License.
 */
package org.jbuilt.common.renderkit.html;
...
/**
 * this file has been altered to fit the architecture of the jbuilt
 * library original author information is below.
 */
...
public final class HtmlRendererUtils {
                                                ...
                                                ResponseWriter writer) throws IOException
    {
        ...
        if (oldViewId != null && oldViewId.equals(facesContext.getViewRoot().getViewId()))
        {
            ...
            String scrolling = externalContext.getRequestParameterMap().get(AUTO_SCROLL_PARAM);
    ...
    public static String selectContentType(String contentTypeListString) {
        if (contentTypeListString == null) {
            ...
            if (context != null) {
                contentTypeListString = context.getExternalContext().getRequestHeaderMap().get("Accept");
            }
