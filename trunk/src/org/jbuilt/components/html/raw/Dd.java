...
public class Dd extends AbstractComponent implements HasStringBody  {
  ...
  public void encodeAll(FacesContext context){
	...
	Dd dd = (Dd) component;
	try {
		dd.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		dd.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "dd", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
