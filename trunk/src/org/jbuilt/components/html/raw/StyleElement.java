...
public class StyleElement extends AbstractComponent implements HasStringBody {

    static public final String COMPONENT_TYPE =
        "org.jbuilt.StyleElement";
    public StyleElement(){
  ...
  public void encodeAll(FacesContext context){
	...
	StyleElement styleElement = (StyleElement) component;
	try {
		styleElement.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		styleElement.encodeEnd(context, component);
	} catch (IOException e) {
...
//			            this.stringBuilder.append(this.textString);
//			            writer.write(this.stringBuilder.toString());
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "style", new String[ ] { "src",  "id",  "name",  "value", "type" });
}
