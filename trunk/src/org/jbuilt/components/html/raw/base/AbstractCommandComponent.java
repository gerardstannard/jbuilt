 ...
 * @version
 */
public abstract class AbstractCommandComponent extends UICommand implements Jbuilt {
//    public static final String COMPONENT_TYPE = "org.jbuilt.Command";
...
//    private List<Observer> observers;
     ...
     * 
     */
    private static final long serialVersionUID = -1797883956417158579L;




    public AbstractCommandComponent(){
//    	observers = new ArrayList<Observer>();
  ...
  private  boolean isReset() {
      ...
      return "reset".equals(getAttributes().get("type"));
  ...
  public void decode(FacesContext context) {
      ...
      if (wasClicked(context, this) && !isReset()) {
