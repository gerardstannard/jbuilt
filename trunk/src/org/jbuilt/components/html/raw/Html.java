...
public class Html extends AbstractComponent {
	...
	ValueExpression ve = getValueExpression("xmlns");
	if (ve != null) {
	    try {
		return (String) ve.getValue(getFacesContext().getELContext());
	    }
  ...
  public void encodeAll(FacesContext context){
	...
	try {
		html.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		html.encodeEnd(context, component);
	} catch (IOException e) {
    ...
    public void encodeBegin(FacesContext context, UIComponent component)
                  ...
                  return;
			        ...
			        if (this.isRendered()) {
					 ...
					 "id",  "dir",  "lang",  "title",  "style",  "styleClass",  "xmlns" });
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "html", new String[ ] { "id",  "dir",  "lang",  "title",  "style",  "styleClass",  "xmlns" });
}
