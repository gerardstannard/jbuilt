...
public class Canvas extends UIGraphic {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "canvas", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass",  "align",  "alt",  "border",  "height",  "hspace",  "ismap",  "longdesc",  "usemap",  "vspace",  "width" });
}
