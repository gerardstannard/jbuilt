...
public class Code extends AbstractComponent implements HasStringBody  {
	...
	ValueExpression ve = getValueExpression("idX");
	if (ve != null) {
	    try {
  ...
  public void encodeAll(FacesContext context){
	...
	Code pre = (Code) component;
	try {
		pre.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		pre.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "code", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
