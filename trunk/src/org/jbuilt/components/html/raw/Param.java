...
public class Param extends AbstractComponent {
  ...
  public void encodeAll(FacesContext context){
	...
	try {
		param.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		param.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "param", new String[ ] { "id",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
