...
public class Blockquote extends AbstractComponent implements HasStringBody  {
  ...
  public void encodeAll(FacesContext context){
	...
	Blockquote blockquote = (Blockquote) component;
	try {
		blockquote.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		blockquote.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "blockquote", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
