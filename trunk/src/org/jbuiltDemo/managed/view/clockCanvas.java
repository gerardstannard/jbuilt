...
public class clockCanvas extends BaseView {
    

    @Inject
    public clockCanvas(@_ClockCanvasView ViewClosure viewClosure,
    ...
    public void beforeWriteView(){
        ...
        log("clockCanvas, calling super, then overriding, before write view");
    ...
    public void afterWriteView(){
        ...
        log("clockCanvas, calling super, then overriding, after write view");
    }
