...
function initSliders()
{
  ...
  for (var i = 0; i < sliderReplacements.length; i++)
  {
    ...
    slider.id = "sliderWidget"+i;
    slider.style.color = "black";
    slider.style.fontWeight = "bold";
    slider.innerHTML = parseInt(document.getElementById("pieChartForm:data"+(i+1)).getAttribute("value"));
    ...
    slider.innerHTML = "$"+parseInt(sliderReplacements[i].getAttribute("value"), 10);
...
function mousemoveSlider(event)
{
  ...
  slider.innerHTML = "$"+Math.round(sliderLeft / increment) * increment;

	var data1 = parseInt(document.getElementById(formId+"data1").getAttribute("value"));
	var data2 = parseInt(document.getElementById(formId+"data2").getAttribute("value"));
	var data3 = parseInt(document.getElementById(formId+"data3").getAttribute("value"));
	var data4 = parseInt(document.getElementById(formId+"data4").getAttribute("value"));
	var data5 = parseInt(document.getElementById(formId+"data5").getAttribute("value"));
	var data6 = parseInt(document.getElementById(formId+"data6").getAttribute("value"));
