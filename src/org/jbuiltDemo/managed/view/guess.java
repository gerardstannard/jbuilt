...
public class guess extends BaseView {
	

	@Inject
	public guess(@_GuessView ViewClosure viewClosure,
	...
	public void beforeWriteView(){
		...
		log("calling super, then overriding, before write view");
	...
	public void afterWriteView(){
		...
		log("calling super, then overriding, after write view");
	}
