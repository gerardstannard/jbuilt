...
public class GridView extends BaseViewClosure {
@Inject
GridView(@_UIViewRoot UIComponent tree, FacesContext facesContext,
	...
	body(
		div (
			...
			div (
				...
				role("application"),
				h1(
			        style(borderStyle(BorderStyle.solid), borderColor(blue)),
					text( "Header"),
					br(),
                    text(
			...
			div (
				...
				div (
					styleClass("yui-g"),
                    style(borderStyle(BorderStyle.solid), borderColor(red)),
					text("main"),
					br(),
					text(
				        "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas sit amet metus. Nunc quam elit, posuere nec, auctor in, rhoncus quis, dui. Aliquam erat volutpat. Ut dignissim, massa sit amet dignissim cursus, quam lacus feugiat.",
				...
				div (
					styleClass("yui-gc"),
					div (
						styleClass("yui-u first"),
	                    style(borderStyle(BorderStyle.solid), borderColor(green)),
	                    text("yui-u first"),
	                    br(),
	                    text(
                            "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas sit amet metus. Nunc quam elit, posuere nec, auctor in, rhoncus quis, dui. Aliquam erat volutpat. Ut dignissim, massa sit amet dignissim cursus, quam lacus feugiat.",
					...
					div (
						styleClass("yui-u"),
	                    style(borderStyle(BorderStyle.solid), borderColor(yellow)),
	                    text("yui-u"),
	                    br(),
                        text(
                            "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas sit amet metus. Nunc quam elit, posuere nec, auctor in, rhoncus quis, dui. Aliquam erat volutpat. Ut dignissim, massa sit amet dignissim cursus, quam lacus feugiat.",
				...
				div (
					styleClass("yui-g"),
                    style(borderStyle(BorderStyle.solid), borderColor(navy)),
                    text("yui-g"),
                    br(),
                    text(
                        "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas sit amet metus. Nunc quam elit, posuere nec, auctor in, rhoncus quis, dui. Aliquam erat volutpat. Ut dignissim, massa sit amet dignissim cursus, quam lacus feugiat.",
				...
				div (
					...
					div (
						styleClass("yui-u first"),
	                    style(borderStyle(BorderStyle.solid), borderColor(orange)),
	                    text("yui-g"),
	                    br(),
                        text(
                            "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas sit amet metus. Nunc quam elit, posuere nec, auctor in, rhoncus quis, dui. Aliquam erat volutpat. Ut dignissim, massa sit amet dignissim cursus, quam lacus feugiat.",
					...
					div (
						styleClass("yui-u"),
	                    style(borderStyle(BorderStyle.solid), borderColor(gray)),
	                    text("yui-u"),
	                    br(),
                        text(
                            "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas sit amet metus. Nunc quam elit, posuere nec, auctor in, rhoncus quis, dui. Aliquam erat volutpat. Ut dignissim, massa sit amet dignissim cursus, quam lacus feugiat.",
			...
			div (
				...
				role("contentinfo"),
				p(
                    style(borderStyle(BorderStyle.solid), borderColor(purple)),
                    text("Footer"),
                    br(),
                     text(
                        "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas sit amet metus. Nunc quam elit, posuere nec, auctor in, rhoncus quis, dui. Aliquam erat volutpat. Ut dignissim, massa sit amet dignissim cursus, quam lacus feugiat.",
