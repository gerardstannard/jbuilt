...
public class Tr extends AbstractComponent {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "tr", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
