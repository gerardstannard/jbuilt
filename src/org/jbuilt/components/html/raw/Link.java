...
public class Link extends AbstractComponent {
  ...
  public void encodeAll(FacesContext context){
	...
	try {
		link.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		link.encodeEnd(context, component);
	} catch (IOException e) {
    ...
    public void encodeBegin(FacesContext context, UIComponent component)
                  ...
                  return;
			        ...
			        if (this.isRendered()) {
					 ...
					 "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass",  "href",  "rel" });
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "link", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass",  "href",  "rel" });
}
    ...
    public void restoreState(FacesContext facesContext, Object state)
    {
		...
		href = (String) values[15 ];
		rel = (String) values[16 ];
    }
