...
public class Label extends AbstractComponent {
	...
	ValueExpression ve = getValueExpression("forAttribute");
	if (ve != null) {
	    try {
		return (String) ve.getValue(getFacesContext().getELContext());
	    }
  ...
  public void encodeAll(FacesContext context){
	...
	try {
		label.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		label.encodeEnd(context, component);
	} catch (IOException e) {
    ...
    public void encodeBegin(FacesContext context, UIComponent component)
                  ...
                  return;
			        ...
			        if (this.isRendered()) {
					 ...
					 "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass",  "accesskey",  "onblur",  "onfocus",  "for" });
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "label", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass",  "accesskey",  "onblur",  "onfocus",  "for" });
}
    ...
    public void restoreState(FacesContext facesContext, Object state)
    {
		...
		onfocus = (String) values[17 ];
		forAttribute = (String) values[18 ];
    }
