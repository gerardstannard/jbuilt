...
import org.jbuilt.components.html.raw.base.RowMember;

public class Th extends AbstractComponent implements RowMember  {
  ...
  public void encodeAll(FacesContext context){
	...
	Th tr = (Th) component;
	try {
		tr.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		tr.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "th", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
