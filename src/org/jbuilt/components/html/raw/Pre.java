...
public class Pre extends AbstractComponent implements HasStringBody  {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "pre", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
