...
public class Caption extends AbstractComponent implements HasStringBody  {
  ...
  public void encodeAll(FacesContext context){
	...
	try {
		caption.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		caption.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "caption", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
