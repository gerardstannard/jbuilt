...
public class TitleElement extends AbstractComponent implements HasStringBody {

    static public final String COMPONENT_TYPE =
        "org.jbuilt.TitleElement";
  ...
  public void encodeAll(FacesContext context){
	...
	TitleElement titleElement = (TitleElement) component;
	try {
		titleElement.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		titleElement.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "title", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
