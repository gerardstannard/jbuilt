...
public class Head extends AbstractComponent {
  ...
  public void encodeAll(FacesContext context){
	...
	try {
		head.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		head.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "head", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
