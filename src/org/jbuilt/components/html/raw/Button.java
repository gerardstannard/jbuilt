...
import org.jbuilt.components.html.raw.base.AbstractCommandComponent;
import org.jbuilt.utils.MethodClosure;
import org.jbuilt.utils.ValueClosure;

public class Button extends AbstractCommandComponent {
	...
	if (ve != null) {
//	    try {
//		return (MethodExpression) (ve.getValue(getFacesContext().getELContext()));
//	    }
//	    catch (ELException e) {
//		throw new FacesException(e);
//	    }
  ...
  public void encodeAll(FacesContext context){
	...
	try {
		button.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		button.encodeEnd(context, component);
	} catch (IOException e) {
    ...
    public void encodeBegin(FacesContext context, UIComponent component)
                  ...
                  return;
			        ...
			        if (this.isRendered()) {
					 ...
					 "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass",  "align",  "alt",  "datafld",  "datasrc",  "dataformatas",  "ondblclick",  "onmousedown",  "onmouseup",  "onmouseover",  "onmousemove",  "onmouseout",  "onkeypress",  "onkeydown",  "onkeyup",  "onclick" });
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "button", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass",  "align",  "alt",  "datafld",  "datasrc",  "dataformatas",  "ondblclick",  "onmousedown",  "onmouseup",  "onmouseover",  "onmousemove",  "onmouseout",  "onkeypress",  "onkeydown",  "onkeyup",  "onclick" });
}
	...
	values[17 ] = datafld;
	values[18 ] = datasrc;
	values[19 ] = dataformatas;
	values[20 ] = ondblclick;
	values[21 ] = onmousedown;
	values[22 ] = onmouseup;
	values[23 ] = onmouseover;
	values[24 ] = onmousemove;
	values[25 ] = onmouseout;
	values[26 ] = onkeypress;
	values[27 ] = onkeydown;
	values[28 ] = onkeyup;
	values[29 ] = onclick;
	return values;
    ...
    public void restoreState(FacesContext facesContext, Object state)
    {
		...
		datafld = (String) values[17 ];
		datasrc = (String) values[18 ];
		dataformatas = (String) values[19 ];
		ondblclick = (String) values[20 ];
		onmousedown = (String) values[21 ];
		onmouseup = (String) values[22 ];
		onmouseover = (String) values[23 ];
		onmousemove = (String) values[24 ];
		onmouseout = (String) values[25 ];
		onkeypress = (String) values[26 ];
		onkeydown = (String) values[27 ];
		onkeyup = (String) values[28 ];
		onclick = (String) values[29 ];
    }
