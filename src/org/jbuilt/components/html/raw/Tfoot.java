...
public class Tfoot extends AbstractComponent implements HasStringBody  {
  ...
  public void encodeAll(FacesContext context){
	...
	Tfoot tfoot = (Tfoot) component;
	try {
		tfoot.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		tfoot.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "tfoot", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
