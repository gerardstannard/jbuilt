...
public class Meta extends AbstractComponent {
  ...
  public void encodeAll(FacesContext context){
	...
	try {
		meta.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		meta.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "meta", new String[ ] { "id",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
