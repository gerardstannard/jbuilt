...
public class Optgroup extends AbstractComponent {
  ...
  public void encodeAll(FacesContext context){
	...
	try {
		optgroup.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		optgroup.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "optgroup", new String[ ] { "id",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
