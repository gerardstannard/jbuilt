...
public class Div extends AbstractComponent {
  ...
  public void encodeAll(FacesContext context){
	...
	try {
		div.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		div.encodeEnd(context, component);
	} catch (IOException e) {
    ...
    public void encodeBegin(FacesContext context, UIComponent component)
                  ...
                  return;
			        ...
			        if (this.isRendered()) {
					 ...
					 "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass", "onclick" });
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "div", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass", "onclick" });
}
