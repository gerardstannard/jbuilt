...
public class Colgroup extends AbstractComponent {
  ...
  public void encodeAll(FacesContext context){
	...
	Colgroup colgroup = (Colgroup) component;
	try {
		colgroup.encodeBegin(context, component);
		for(UIComponent child : getChildren()) {
				child.encodeAll(context);
		}
		colgroup.encodeEnd(context, component);
	} catch (IOException e) {
 ...
 HtmlRendererUtils.renderOptionalEndElement(writer, component, "colgroup", new String[ ] { "id",  "name",  "value",  "method",  "action",  "colspan",  "scope",  "label",  "selected",  "dir",  "lang",  "title",  "style",  "styleClass" });
}
