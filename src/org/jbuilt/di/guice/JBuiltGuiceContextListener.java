...
//                        bind(Counter.class).annotatedWith(named(FLASH)).to(Counter.class).in(FlashScoped.class);
        ...
        //TODO: extract into separate modules.  having them all here
        // defeats the purpose of having modules
	...
	public void contextInitialized(ServletContextEvent contextEvent){
		...
		context.setAttribute("jbuilt.BASE_VIEW_PATH", "/org/jbuiltTest/managed/view");
	...
	/**
	 * Initializes the Guice injector based on configuration defined on web.xml
	 * params (com.guicesf.Modules and com.guicesf.AutoDiscover) and register
	 * this injector on ServletContext (application) to be used on ELResolvers;
	 */
//	public void contextInitialized(ServletContextEvent contextEvent) {
//		ServletContext context = contextEvent.getServletContext();
//		String moduleNames = contextEvent.getServletContext().getInitParameter(MODULES_PARAM);
//		Boolean autoDiscover = Boolean.valueOf(contextEvent.getServletContext().getInitParameter(AUTO_DISCOVER_PARAM));
//		ModuleManager moduleManager = ModuleManager.getInstance();
//		Injector injector = null;
//		if (autoDiscover) {
//			LOG.log(Level.INFO, "Loading auto-discovery mode...");
//			AnnotationScanner.scan(context, AnnotationScanner.CLASSES_DIR);
//			Module[] guiceModules = moduleManager.getModules();
//			injector = Guice.createInjector(guiceModules);
//		} else {
//			LOG.log(Level.INFO, "Loading default mode...");
//			moduleManager.loadModules(moduleNames);
//			Module[] guiceModules = moduleManager.getModules();
//			injector = Guice.createInjector(guiceModules);
//		}
//		context.setAttribute(Injector.class.getName(), injector);
//		LOG.log(Level.INFO, "Guicesf initialized!");
//	}

	/**
	 * Unregister Guice injector
	 */
//	public void contextDestroyed(ServletContextEvent contextEvent) {
//		ServletContext context = contextEvent.getServletContext();
//		context.removeAttribute(Injector.class.getName());
//		LOG.log(Level.INFO, "Guicesf finhised");
//	}
}
