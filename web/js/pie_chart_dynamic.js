...
function init()
{
	var data1 = parseInt(document.getElementById("pieChartForm:data1").getAttribute("value"));
	var data2 = parseInt(document.getElementById("pieChartForm:data2").getAttribute("value"));
	var data3 = parseInt(document.getElementById("pieChartForm:data3").getAttribute("value"));
	var data4 = parseInt(document.getElementById("pieChartForm:data4").getAttribute("value"));
	var data5 = parseInt(document.getElementById("pieChartForm:data5").getAttribute("value"));
	var data6 = parseInt(document.getElementById("pieChartForm:data6").getAttribute("value"));
	...
	setTimeout(function()
		{
			new PieChart(data, radius/*, "chart"*/);
		},
		1
	);
};
...
//	this.id = id;
	...
	this.canvas = document.getElementById(/*this.id*/"pieChartForm:chart1");
